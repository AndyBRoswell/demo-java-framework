...
public class test {
	public static void main(String[] args) {
		try {
			...
			final user user_selected = SQL_session.selectOne("persistence.mybatis_mapper.user-mapper.select_user_by_id", 1);
			...
			SQL_session.insert("persistence.mybatis_mapper.user-mapper.add_user", user_to_be_added);
			...
			SQL_session.update("persistence.mybatis_mapper.user-mapper.update_user", user_to_be_updated);
			SQL_session.delete("persistence.mybatis_mapper.user-mapper.delete_user", 2);
			final List<user> user_list = SQL_session.selectList("persistence.mybatis_mapper.user-mapper.select_all_user");
