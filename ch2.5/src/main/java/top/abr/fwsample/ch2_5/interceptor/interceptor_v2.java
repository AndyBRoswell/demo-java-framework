...
public class interceptor_v2 implements HandlerInterceptor {
	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		System.out.println("interceptor_v2.preHandle方法执行中");
	...
	public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView model_and_view) throws Exception {
		System.out.println("interceptor_v2.postHandle方法执行中");
	}
	@Override
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception exception) throws Exception {
		System.out.println("interceptor_v2.afterCompletion方法执行中");
	}
}
